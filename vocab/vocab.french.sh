...
$spm_exec --bos_id=-1 --eos_id=0 --unk_id=1 ${placeholders} ${char_cov} ${prefix} --vocab_size=${vocab_size} --input=/mnt/startiger0/nbogoych/enfr/dedup/clean.med,/mnt/startiger0/nbogoych/enfr/dedup/clean --input_sentence_size=5000000 --byte_fallback --shuffle_input_sentence #--input_format=tsv seems broken
